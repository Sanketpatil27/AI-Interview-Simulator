            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription asChild>
                        <div className='mt-5'>
                            <h2 className='text-black'> Enter Job Description </h2>
                            <Textarea
                                className='mt-2'
                                placeholder="Enter description of the job field"
                                onChange={(e) => setTopic(e.target.value)}
                            />

                            <h2 className='text-black mt-5'> Select Interviewer </h2>
                                        ...
                                        <div key={index} onClick={() => { setSelectedExpert(expert.name) }} >
                                            <Image
                                                ...
                                                className={`rounded-2xl h-[80px] w-[80px] object-cover hover:scale-105 
                                                            transition-all cursor-pointer p-1 border-primary
